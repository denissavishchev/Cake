...
class ToggleButtonsTop extends StatefulWidget {
  @override
  ToggleButtonsTopState createState() => ToggleButtonsTopState();
}

class ToggleButtonsTopState extends State<ToggleButtonsTop> {
                ...
                setState(() {
                  ...
                  indexBtn++) {
                    if (indexBtn == index) {
                      ...
                      // if (index == 2){
                      // setState(() {
                      //   TextInputsRightTopState.tcVis = true;
                      // });
                      // } else {
                      //   setState(() {
                      //     TextInputsRightTopState.tcVis = false;
                      //   });
                      // }
                    } else {
...
class ToggleButtonsBottom extends StatefulWidget {
  @override
  ToggleButtonsBottomState createState() => ToggleButtonsBottomState();
}

class ToggleButtonsBottomState extends State<ToggleButtonsBottom> {
  static List<bool> isSelected = [true, false, false];
  List<IconData> iconList = [Icons.radio_button_off, Icons.check_box_outline_blank, Icons.rectangle_outlined];
                ...
                setState(() {
                  ...
                  indexBtn++) {
                    if (indexBtn == index) {
                      ...
                      // if (index == 2){
                      //   setState(() {
                      //     TextInputsRightBottomState.tcVis = true;
                      //   });
                      // } else {
                      //   setState(() {
                      //     TextInputsRightBottomState.tcVis = false;
                      //   });
                      // }
                    } else {
                      isSelected[indexBtn] = false;
